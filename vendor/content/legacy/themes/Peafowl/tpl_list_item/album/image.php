<div class="list-item c%COLUMN_SIZE_IMAGE% gutter-margin-right-bottom" data-category-id="%IMAGE_CATEGORY_ID%" data-flag="%IMAGE_FLAG%" data-id="%IMAGE_ID_ENCODED%" data-album-id="%IMAGE_ALBUM_ID_ENCODED%" data-type="image" data-media="%IMAGE_TYPE%" data-size="%IMAGE_SIZE%" data-liked="%IMAGE_LIKED%" data-description="%IMAGE_DESCRIPTION%" data-title="%IMAGE_TITLE%" data-privacy="%IMAGE_ALBUM_PRIVACY%" data-url-short="%IMAGE_URL_SHORT%" data-thumb="%IMAGE_THUMB_URL%" %DATA_OBJECT%>
